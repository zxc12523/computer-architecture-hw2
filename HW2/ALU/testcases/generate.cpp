...
#define WRITE_I(inst, b, a) \
    file_i << bitset<5>(inst) << "_" << bitset<32>(b) <<  "_" << bitset<32>(a) << endl;
...
// signed less than
    file_i.open("test15_input.txt", ios::out | ios::trunc);
    file_o.open("test15_output.txt", ios::out | ios::trunc);
    printf("slt test\n");
...
// signed greater than or equal to
    file_i.open("test16_input.txt", ios::out | ios::trunc);
    file_o.open("test16_output.txt", ios::out | ios::trunc);
    printf("sge test\n");
